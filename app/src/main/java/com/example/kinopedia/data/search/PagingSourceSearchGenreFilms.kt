...
class PagingSourceSearchGenreFilms @AssistedInject constructor(
    @Assisted private val genre: Int,
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, KinopoiskFilmModel> =
        withContext(
            ...
            try {
                val result = apiService.getFilmByFilters(genres = arrayOf(genre), page = fromPage)
