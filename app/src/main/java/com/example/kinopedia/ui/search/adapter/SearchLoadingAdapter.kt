...
import com.example.kinopedia.databinding.LayoutFilmItemLoadingHorizontalBinding
import com.example.kinopedia.utils.OnRetryClickListener

class SearchLoadingAdapter(private val onRetryClickListener: OnRetryClickListener) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, loadState: LoadState): AdapterViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.layout_film_item_loading_horizontal, parent, false)
        val binding = LayoutFilmItemLoadingHorizontalBinding.bind(view)
...
class AdapterViewHolder(
    private val binding: LayoutFilmItemLoadingHorizontalBinding,
