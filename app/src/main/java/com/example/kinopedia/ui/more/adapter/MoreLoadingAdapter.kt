...
class MoreLoadingAdapter(private val onRetryClickListener: OnRetryClickListener): LoadStateAdapter<AdapterViewHolder>() {
    ...
    val view = LayoutInflater.from(parent.context).inflate(R.layout.layout_film_item_loading_vertical, parent, false)
